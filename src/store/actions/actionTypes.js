...
export const GET_ALL_SUBMISSIONS_FAILED = 'GET_ALL_SUBMISSIONS_FAILED';
...
export const GET_SUBMISSIONS_BY_AUTHOR_FAILED = 'GET_SUBMISSIONS_BY_AUTHOR_FAILED';
export const GET_SUBMISSIONS_DETAIL_SUCCESS = 'GET_SUBMISSIONS_DETAIL_SUCCESS';
export const GET_SUBMISSIONS_DETAIL_FAILED = 'GET_SUBMISSIONS_DETAIL_FAILED';
